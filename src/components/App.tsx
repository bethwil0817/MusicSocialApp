				...
				>
					...
					<AnimatePresence>
						{showRevolLoad && (
							...
							>
								<div className="my-auto w-full text-6xl md:text-6xl lg:text-8xl gap-y-2 items-center justify-center tracking-wide sm:tracking-[0.35em] text-[#f3e5cd] text-center uppercase">
									Revolūtiō
								</div>
							</motion.div>
						)}
